...
export const PROVIDER_CATALOG: readonly ProviderDescriptor[] = [
	...
	},
	{
		...
		isLocal: false,
		transport: "openai-compatible-http",
		// International host. kosha previously pointed the sole `moonshot`
		// provider at `api.moonshot.cn`, the mainland-China endpoint, which an
		// international key cannot authenticate against; `moonshot-cn` now
		// carries that host explicitly.
	...
	},
	{
		...
		canonicalProviderId: "moonshot-cn",
		aliases: ["kimi-cn", "moonshot_cn"],
		...
		credentialRequired: true,
		credentialEnvVars: ["MOONSHOT_CN_API_KEY", "MOONSHOT_API_KEY", "KIMI_API_KEY"],
		primaryCredentialEnvVar: "MOONSHOT_CN_API_KEY",
		cacheBehavior: {
			mode: "automatic",
			approximateTtlSeconds: 3600,
			documented: true,
			notes: "Same automatic prefix cache as the international host; prices are quoted separately.",
		},
	},
	{
		providerId: "minimax-cn",
		canonicalProviderId: "minimax-cn",
		aliases: ["minimaxi", "minimax_cn"],
		name: "MiniMax (China)",
		origin: "direct",
		isLocal: false,
		transport: "openai-compatible-http",
		...
		credentialRequired: true,
		credentialEnvVars: ["MINIMAX_CN_API_KEY", "MINIMAX_API_KEY"],
		primaryCredentialEnvVar: "MINIMAX_CN_API_KEY",
	},
	{
		providerId: "alibaba-cn",
		canonicalProviderId: "alibaba-cn",
		aliases: ["dashscope-cn", "qwen-cn"],
		name: "Alibaba Model Studio (Qwen, China)",
		origin: "direct",
		isLocal: false,
		transport: "openai-compatible-http",
		defaultBaseUrl: "https://dashscope.aliyuncs.com/compatible-mode/v1",
		credentialRequired: true,
		credentialEnvVars: ["DASHSCOPE_CN_API_KEY", "DASHSCOPE_API_KEY"],
		primaryCredentialEnvVar: "DASHSCOPE_CN_API_KEY",
		cacheBehavior: {
			mode: "automatic",
			documented: true,
			notes: "Qwen context cache; the China region publishes its own (generally lower) rates.",
		},
	},
	{
		providerId: "siliconflow-cn",
		canonicalProviderId: "siliconflow-cn",
		aliases: ["silicon-flow-cn"],
		...
		credentialRequired: true,
		credentialEnvVars: ["SILICONFLOW_CN_API_KEY", "SILICONFLOW_API_KEY"],
		primaryCredentialEnvVar: "SILICONFLOW_CN_API_KEY",
	},
	{
		providerId: "stepfun",
		...
		credentialRequired: true,
		credentialEnvVars: ["STEPFUN_API_KEY"],
		primaryCredentialEnvVar: "STEPFUN_API_KEY",
	},
	{
		providerId: "stepfun-cn",
		canonicalProviderId: "stepfun-cn",
		aliases: ["step-cn"],
		name: "StepFun (China)",
		origin: "direct",
		isLocal: false,
		...
		credentialRequired: true,
		credentialEnvVars: ["STEPFUN_CN_API_KEY", "STEPFUN_API_KEY"],
		primaryCredentialEnvVar: "STEPFUN_CN_API_KEY",
	},
	{
		providerId: "xai",
		canonicalProviderId: "xai",
		aliases: ["x-ai", "grok"],
		name: "xAI",
		origin: "direct",
		isLocal: false,
		...
		credentialRequired: true,
		credentialEnvVars: ["XAI_API_KEY", "GROK_API_KEY"],
		primaryCredentialEnvVar: "XAI_API_KEY",
		cacheBehavior: {
			mode: "automatic",
			documented: true,
			notes: "Grok caches repeated prompt prefixes automatically and bills them at a reduced rate; no TTL published.",
		},
	},
	{
		providerId: "typesafe",
		canonicalProviderId: "typesafe",
		aliases: ["jev", "system-one", "systemone"],
		name: "TypeSafe",
		origin: "direct",
		isLocal: false,
		transport: "native-http",
		...
		credentialRequired: true,
		credentialEnvVars: ["TYPESAFE_API_KEY", "JEV_API_KEY"],
		primaryCredentialEnvVar: "TYPESAFE_API_KEY",
		cacheBehavior: { mode: "none", documented: true, notes: "System One evaluation is single-shot; no prompt cache." },
	},
	{
		providerId: "thinkingmachines",
		canonicalProviderId: "thinkingmachines",
		aliases: ["thinking-machines", "tinker"],
		name: "Thinking Machines",
		origin: "direct",
		isLocal: false,
		transport: "native-http",
		defaultBaseUrl: "https://tinker.thinkingmachines.dev/services/tinker-prod/anthropic/api/v1",
		credentialRequired: true,
		credentialEnvVars: ["TINKER_API_KEY", "THINKINGMACHINES_API_KEY"],
		primaryCredentialEnvVar: "TINKER_API_KEY",
		cacheBehavior: {
			mode: "passthrough",
			documented: false,
			notes: "Anthropic-wire endpoint; accepts cache_control but the cache policy is not documented.",
		},
	},
	{
		providerId: "alibaba",
		canonicalProviderId: "alibaba",
		aliases: ["dashscope", "qwen", "modelstudio"],
		...
		credentialRequired: true,
		credentialEnvVars: ["DASHSCOPE_API_KEY", "ALIBABA_API_KEY", "QWEN_API_KEY"],
		primaryCredentialEnvVar: "DASHSCOPE_API_KEY",
		cacheBehavior: {
			mode: "automatic",
			documented: true,
			notes: "Qwen context cache engages automatically on repeated prefixes; billed at a cache-hit rate.",
		},
	},
	{
		providerId: "volcengine",
		canonicalProviderId: "volcengine",
		aliases: ["ark", "doubao"],
		...
		credentialRequired: true,
		credentialEnvVars: ["ARK_API_KEY", "VOLCENGINE_API_KEY"],
		primaryCredentialEnvVar: "ARK_API_KEY",
	},
	{
		providerId: "inception",
		canonicalProviderId: "inception",
		aliases: ["inceptionlabs", "mercury"],
		...
		credentialRequired: true,
		credentialEnvVars: ["INCEPTION_API_KEY"],
		primaryCredentialEnvVar: "INCEPTION_API_KEY",
	},
	{
		providerId: "ai21",
		canonicalProviderId: "ai21",
		aliases: ["jamba"],
		name: "AI21 Labs",
		origin: "direct",
		isLocal: false,
		...
		primaryCredentialEnvVar: "AI21_API_KEY",
	},
	{
		providerId: "upstage",
		canonicalProviderId: "upstage",
		aliases: ["solar"],
		name: "Upstage (Solar)",
		origin: "direct",
		isLocal: false,
		...
		credentialRequired: true,
		credentialEnvVars: ["UPSTAGE_API_KEY"],
	...
	},
	{
		...
		credentialRequired: true,
		credentialEnvVars: ["BASETEN_API_KEY"],
		primaryCredentialEnvVar: "BASETEN_API_KEY",
	},
	{
		providerId: "nebius",
		canonicalProviderId: "nebius",
		aliases: ["nebius-token-factory", "tokenfactory"],
		...
		credentialRequired: true,
		credentialEnvVars: ["NEBIUS_API_KEY"],
		primaryCredentialEnvVar: "NEBIUS_API_KEY",
	},
	{
		providerId: "novita",
		canonicalProviderId: "novita",
		aliases: ["novita-ai"],
		name: "Novita AI",
		origin: "proxy",
		isLocal: false,
		...
		primaryCredentialEnvVar: "NOVITA_API_KEY",
	},
	{
		providerId: "siliconflow",
		canonicalProviderId: "siliconflow",
		...
		credentialRequired: true,
		credentialEnvVars: ["SILICONFLOW_API_KEY"],
		primaryCredentialEnvVar: "SILICONFLOW_API_KEY",
	},
	{
		providerId: "huggingface",
		canonicalProviderId: "huggingface",
		...
		credentialRequired: true,
		credentialEnvVars: ["HF_TOKEN", "HUGGINGFACE_API_KEY", "HUGGING_FACE_HUB_TOKEN"],
		primaryCredentialEnvVar: "HF_TOKEN",
		cacheBehavior: {
			mode: "passthrough",
			documented: false,
			notes: "Router forwards to a third-party inference provider; cache behaviour follows whichever one serves the request.",
		},
	},
	{
		providerId: "ollama-cloud",
		canonicalProviderId: "ollama-cloud",
		aliases: ["ollama_cloud", "ollamacloud"],
		name: "Ollama Cloud",
		origin: "proxy",
		isLocal: false,
		transport: "openai-compatible-http",
		...
		primaryCredentialEnvVar: "OLLAMA_API_KEY",
	},
	{
		providerId: "minimax",
